...
// Change the API_URL to the correct location of the backend API before deploying the
app
const API_URL = 'http://nthies.pythonanywhere.com/'; /* 'http://localhost:8000'
http://127.0.0.1:8000/ or 'http://nthies.pythonanywhere.com/'*/
