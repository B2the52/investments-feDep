...
left">{{ customer.name }}</h6>
          </button>
        </div>
        <div :id="'collapse' + customer.pk" class="collapse" :arialabelledby="'heading' + customer.pk"
          ...
          <div class="card-body">
            ...
            <div v-if="(this.userID === customer.agent ||
this.is_superuser === 'true')" class="btn-group">
            ...
            <div v-else class="btn-group">
              <button style="background-color: transparent; padding:
0;" disabled>
                <font-awesome-icon icon="pencil"/>
              </button>
              <button style="background-color: transparent; padding:
    ...
    <div class="col col-12 col-md-10 d-none d-xl-block d-lg-block d-md-block">
      <table class="table table-hover" style="overflow-y: auto" :headers="headers">
        ...
        <tr v-for="customer in customers" v-bind:key="customer">
          ...
          <td v-if="(this.userID === customer.agent || this.is_superuser
=== 'true')"
