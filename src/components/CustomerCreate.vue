                ...
                <form ref="form">
                  <div class="container-fluid">
                    ...
                    <div class="form-group row justify-content-around py-2">
                      ...
                      <div class="col col-8">
                        <input v-model="customer.name" type="text" class="formcontrol-sm form-control">
                      </div>
                    </div>
                    <div class="form-group row justify-content-around py-2">
                      <label class="col-4">Address</label>
                      <div class="col col-8">
                        <input v-model="customer.address" type="text" class="formcontrol-sm form-control">
                      </div>
                    </div>
                    <div class="form-group row justify-content-around py-2">
                      <label class="col-4">City</label>
                      <div class="col col-8">
                        <input v-model="customer.city" type="text" class="formcontrol-sm form-control">
                      </div>
                    </div>
                    <div class="form-group row justify-content-around py-2">
                      <label class="col-4">State</label>
                      <div class="col col-8">
                        <input v-model="customer.state" type="text" class="formcontrol-sm form-control">
                      </div>
                    </div>
                    <div class="form-group row justify-content-around py-2">
                      <label class="col-4">Zip Code</label>
                      <div class="col col-8">
                        <input v-model="customer.zipcode" type="text" class="formcontrol-sm form-control">
                      </div>
                    </div>
                    <div class="form-group row justify-content-around py-2">
                      <label class="col-4">Email</label>
                      <div class="col col-8">
                        <input v-model="customer.email" type="text" class="formcontrol-sm form-control">
                      </div>
                    </div>
                    <div class="form-group row justify-content-around py-2">
                    ...
                    <div class="row justify-content-around">
                      <div v-if="!isUpdate" type="button" class="btn btn-primary
col-4" @click="createCustomer">Save
                      </div>
                      <div v-if="isUpdate" type="button" class="btn btn-primary col4" @click="updateCustomer">Update
                      </div>
