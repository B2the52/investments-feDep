<template>
  <div class="container-fluid">
    ...
    <div class="d-md-none" id="collapsable-card" style="width: 80%">
      ...
      <div class="card" v-for="investment in investments" vbind:key="investment">
        <div class="card-header" :id="'heading' + investment.name">
          <button class="btn btn-link collapsed" data-bstoggle="collapse" :data-bs-target="'#collapse' + investment.pk"
                  aria-expanded="true" :aria-controls="'collapse' +
investment.pk">
            <h6 style="color: #0275d8; float:
left">{{ investment.category }}</h6>
          </button>
        </div>
        <div :id="'collapse' + investment.pk" class="collapse" :arialabelledby="'heading' + investment.pk"
          ...
          <div class="card-body">
            ...
            <p><b>Acquired Value:</b>
              {{ investment.acquired_value }}</p>
    ...
    <div class="col col-12 col-md-10 d-none d-xl-block d-lg-block d-md-block">
      ...
      <button type="button" class="btn btn-primary"
              @click="addNewInvestment">Add New Investment
      </button>
    </div>
  </div>
</template>
