                    ...
                    <div class=" row justify-content-around py-2">
                      ...
                      <div class="col col-8">
                        <select v-model="investment.customer" class="form-select">
                          <option class="form-select form-select-sm " v-for=" item in
list" :value="item.pk" :key="item.pk"> {{ item.name }}
                          </option>
                        </select>
                      </div>
                    </div>
                    <div class="form-group row justify-content-around py-2">
                      ...
                      <div class="col col-8">
                        <input v-model="investment.category" type="text" class="formcontrol-sm form-control">
                      </div>
                    </div>
                    <div class="form-group row justify-content-around py-2">
                    ...
                    <div class="row justify-content-around">
                      <div v-if="!isUpdate" type="button" class="btn btn-primary col4" @click="createInvestment">Save
                      </div>
