<template>
  <div class="container-fluid">
    <div class="row align-items-center justify-content-center">
      <div class="col col-12 align-items-center justify-content-center">
        <blockquote>
          ...
          <footer>
            <small>
              <em>&mdash;Financial Services, your Midwest Financial
                Services Partner.</em>
            </small>
          </footer>
        </blockquote>
      </div>
      <div class="col-12 col-md-10 col-lg-10 col-12 align-items-center justifycontent-center">
    ...
    <div class="d-md-none" id="collapsable-card" style="width: 80%">
      ...
      <div class="card" v-for="stock in stocks" vbind:key="stock">
        <div class="card-header" :id="'heading' + stock.name">
          <button class="btn btn-link collapsed" data-bstoggle="collapse" :data-bs-target="'#collapse' + stock.pk"
                  aria-expanded="true" :aria-controls="'collapse' + stock.pk">
            <h6 style="color: #0275d8; float: left">{{ stock.name }}</h6>
          </button>
        </div>
        <div :id="'collapse' + stock.pk" class="collapse" :arialabelledby="'heading' + stock.pk"
             data-bs-parent="#collapsable-card">
          <div class="card-body">
            <p><b>Customer:</b> {{ stock.customer }}</p>
            <p><b>Category:</b> {{ stock.symbol }}</p>
            <p><b>Description:</b> {{ stock.name }}</p>
            <p><b>Shares:</b> {{ stock.shares }}</p>
            <p><b>Acquired Value:</b> {{ stock.purchase_price }}</p>
            <p><b>Recent Date:</b> {{ stock.purchase_date }}</p>
            <div class="btn-group">
    ...
    <div class="col col-12 col-md-10 d-none d-xl-block d-lg-block d-md-block">
      ...
      <button type="button" class="btn btn-primary" @click="addNewStock">Add New Stock
      </button>
    </div>
  </div>
</template>
